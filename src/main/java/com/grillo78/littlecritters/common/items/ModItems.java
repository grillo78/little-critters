...
public class ModItems {
    ...
    public static final Item MAG = register("magnifying_glass", new MagItem(new Item.Properties().setISTER(()-> MagItemStackTileEntityRenderer::new).tab(ItemGroup.TAB_TOOLS)));
