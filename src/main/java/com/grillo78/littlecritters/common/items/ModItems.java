...
import com.grillo78.littlecritters.client.entities.renderers.MagItemStackTileEntityRenderer;
...
public class ModItems {
    ...
    public static final Item MAG = register("magnifying_glass", new MagItem(new Item.Properties().setISTER(()-> MagItemStackTileEntityRenderer::new).tab(ItemGroups.INSTANCE)));
